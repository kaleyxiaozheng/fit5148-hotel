...
public class WarningMessage {
    ...
    public final static String CHECKIN_DATE = "Checkin date must not be less than today";
    public final static String CHECKOUT_DATE = "Checkout date must be after today";
    ...
    public final static String ss = "daf";
